...
export default function PhoneKiosk() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-slate-950 text-slate-100 p-4 lg:p-6 font-sans flex flex-col justify-between max-w-md md:max-w-4xl lg:max-w-7xl mx-auto">
      
      {/* HEADER SECTION */}
      <div className="py-2 border-b border-white/10 flex items-center justify-between gap-2 mb-2 shrink-0">
      ...
      {errorMsg && (
        <div className="bg-rose-500/10 border border-rose-500/40 text-rose-300 p-3 rounded-xl text-center text-xs my-2 shrink-0 backdrop-blur-md transition-all duration-300">
          ⚠️ {errorMsg}
        </div>
      )}

      {/* MAIN CONTAINER */}
      <div className="flex-1 min-h-0 my-2 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch overflow-hidden">

        {/* LEFT COLUMN: 8-ROOM GRID DISPLAY */}
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between text-xs font-bold text-slate-400 uppercase tracking-wider px-1 mb-2 shrink-0">
        ...
        <div className="flex flex-col h-full min-h-0">
          ...
          {step === 'SELECT_STAFF' && (
            <div className="relative rounded-2xl h-full flex min-h-0">
              ...
              <div className="flex-1 flex flex-col p-4 rounded-2xl border border-white/10 shadow-2xl backdrop-blur-xl bg-slate-950/80 h-full min-h-0 relative z-10 justify-between">
                ...
                {selectedPersons.length > 0 && (
                  <div className="mb-3 p-2.5 bg-transparent border border-blue-600/40 rounded-xl shrink-0">
                    ...
                    filteredStaff.map((s) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-3 rounded-xl text-left font-medium text-sm md:text-base flex items-center justify-between transition-all shrink-0 ${
                            isAlreadyCheckedIn
                ...
                <button
                  ...
                  className="mt-3 w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold rounded-xl text-sm shadow-xl transition active:scale-95 flex items-center justify-center gap-2 shrink-0"
                >
